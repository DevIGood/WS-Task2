                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:block background-color="#f4f4f4" page-break-before="always" height="100%">
                        ...
                        <xsl:for-each select="hotel/rooms/room" >
                            <fo:block background-color="#fff" margin-top="5mm" margin-bottom="3mm" margin-left="5mm" margin-right="5mm">
                                ...
                                <fo:block text-align="center">
                                    <fo:external-graphic src="url('{roomPic}')" width="100%" content-height="100%" content-width="scale-to-fit" scaling="uniform" />
                                </fo:block>
                                <fo:block margin-left="5mm" margin-right="5mm">
                                    <fo:block color="#a7573b" text-transform="uppercase" text-align="left" font-size="15pt">
                                        Details
                                    </fo:block>
                                    ...
                                    <fo:block text-align="right">
                                        <fo:external-graphic src="url('{guarantee}')" width="10%" content-height="10%" content-width="scale-to-fit" scaling="uniform" />
                                    </fo:block>
                                </fo:block>
                                <fo:block margin-left="5mm" margin-right="5mm">
                                    <fo:block color="#a7573b" text-transform="uppercase" text-align="left" font-size="15pt">
